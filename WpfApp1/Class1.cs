...
namespace image_recognizer
{
    public class Classificator
    {
        ...
        InferenceSession session = new InferenceSession(@"C:\Users\vdtri\source\repos\Wpf_C#_2\WpfApp1\resnet50-v1-7.onnx");
        ...
        public Classificator(List<string> lst)
        {
            waitHandler = new ManualResetEvent(true);
            var dir = lst;
            pic_list = new List<Image<Rgb24>>();
